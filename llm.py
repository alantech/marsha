...
async def gpt_func_to_python(func, n_results, stats: dict, defined_types: dict = None, defined_functions: list = None, retries=4, debug=False):
...
```'''
    ...
    try:
        ...
        if retries > 0:
            return await gpt_func_to_python(func, n_results, stats, defined_types, defined_functions, retries - 1, debug)
        else:
